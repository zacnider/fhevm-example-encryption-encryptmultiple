...
export interface EncryptMultipleInterface extends Interface {
...
export interface EncryptMultiple extends BaseContract {
  connect(runner?: ContractRunner | null): EncryptMultiple;
  waitForDeployment(): Promise<this>;

  interface: EncryptMultipleInterface;
