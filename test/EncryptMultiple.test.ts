...
import { EncryptMultiple } from "../types";

/**
 * @title EncryptMultiple Tests
 * @notice Comprehensive tests for EncryptMultiple contract
 * @chapter encryption
 */
describe("EncryptMultiple", function () {
  ...
  async function deployContractFixture() {
    ...
    const ContractFactory = await hre.ethers.getContractFactory("EncryptMultiple");
    ...
    await hre.fhevm.assertCoprocessorInitialized(contract, "EncryptMultiple");
